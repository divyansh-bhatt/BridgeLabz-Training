...
public class FlightUtil {
    ...
    public double calculateFuelToFillTank(String flightName, double currentFuelLevel)
        ...
        if (flightName.equals("SpiceJet")) maxFuel = 200000;
        else if (flightName.equals("Vistara")) maxFuel = 300000;
        else if (flightName.equals("IndiGo")) maxFuel = 250000;
        else if (flightName.equals("Air Arabia")) maxFuel = 150000;
