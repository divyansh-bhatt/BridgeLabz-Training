...
public class EmployeeWageComputationProg {
    ...
    public static void main(String[] args) {
        ...
        final int PART_TIME_HOUR = 8;   // As given in requirement (normally 4, but here 8)
        ...
        int partTimeOrFullTimeWage = workHrs * WAGE_PER_HOUR;
        ...
        System.out.println("Wage (Switch): " + (workHrs* WAGE_PER_HOUR) + "\n");
        ...
        for (int day = 1; day <= 20; day++) {
            empType = random.nextInt(3);
            switch (empType) {
                case 1: workHrs= FULL_DAY_HOUR; break;
                case 2: workHrs= PART_TIME_HOUR; break;
                default: workHrs= 0;
            }
            totalMonthlyWage+=workHrs* WAGE_PER_HOUR;
        }
        ...
        while (totalHours < 100 && totalDays < 20) {
            ...
            totalHours += workHrs;
            totalWage += workHrs*WAGE_PER_HOUR;
        }
